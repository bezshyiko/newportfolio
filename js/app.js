(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            let mainSlider = new core(".slider", {
            ...
            let titlesSlider = new core(".titles", {
                modules: [ Navigation, Mousewheel, freeMode, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            mainSlider.on("slideChange", (() => {
                let currentIndexSlide = mainSlider.realIndex;
                titlesSlider.slideTo(currentIndexSlide, 800, false);
            }));
        }
    }
